      ...
      <main style={{ flex: 1, padding: "3rem 1.5rem" }}>
        <div className="fp-legal-container">
          ...
          <article className="fp-legal-content">
            ...
            <p>
              ¡Totalmente! En MyCertify utilizamos encriptación y medidas de seguridad estándar de la industria. Si deseas conocer más detalles, te invitamos a revisar nuestra sección de <Link href="/seguridad?from=%2F%2Fayuda" style={{ color: "var(--fp-primary)" }}>Seguridad</Link>.
            </p>

            <h2><MaterialIcon>email</MaterialIcon> ¿Aún tienes dudas?</h2>
            <p>
              Si no encontraste la respuesta a tu pregunta en esta sección, puedes ponerte en contacto con nosotros visitando la página de <Link href="/contacto?from=%2F%2Fayuda" style={{ color: "var(--fp-primary)" }}>Contacto</Link>. Estaremos encantados de ayudarte.
            </p>
          </article>
        </div>
      </main>
