  ...
  useEffect(() => {
    ...
    setSelectedItems(restored);
      ...
      .catch(() => {
        ...
        window.location.href = "/iniciar-sesion?next=/areas-interes";
      });
  }, []);
      ...
      <main className="fp-onboarding-main fp-stack-xl">
        ...
        <article className="fp-card fp-card--panel fp-stack-lg">
          ...
          <FlowForm
            ...
            nextHref={isRegistrationFlow ? "/codigo" : "/pagina-principal"}
          ...
          >
            ...
            <div className="fp-row-between" style={{ flexWrap: "wrap" }}>
              <Link className="fp-button fp-button--ghost" href="/informacion-academica">
