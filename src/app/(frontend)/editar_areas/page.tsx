...
export default function EditarAreasPage() {
  ...
  useEffect(() => {
    getProfile()
      ...
      .catch(() => {
        window.location.href = "/iniciar-sesion?next=/editar_areas";
      });
  }, []);
      ...
      <DashboardSidebar
        ...
        footer={
          <div className="fp-stack-md">
            <Link className="fp-sidebar__link fp-label-md" href="/ayuda?from=/editar_areas">
          ...
          <article className="fp-card fp-card--panel fp-stack-lg">
            ...
            >
              ...
              <div className="fp-row-between" style={{ flexWrap: "wrap" }}>
                <Link className="fp-button fp-button--ghost" href="/mi-cuenta">
