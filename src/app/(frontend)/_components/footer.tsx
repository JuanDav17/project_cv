...
export function FrontendFooter() {
  ...
  const from =
    FOOTER_INFO_PATHS.has(currentPathname) && preservedFrom
      ? preservedFrom
      : currentPathname.startsWith("/") || currentPathname.startsWith("/u/")
      ? currentPathname
      : "/";
    ...
    <footer className="fp-footer" id="contacto">
      <div className="fp-footer__inner">
        ...
        <div className="fp-footer__links fp-body-sm">
          <Link href={legalHref("/terminos-condiciones", from)}>
            Terminos y Condiciones
          </Link>
          <Link href={legalHref("/terminos-servicio", from)}>
            Terminos de Servicio
          </Link>
          <Link href={legalHref("/seguridad", from)}>Seguridad</Link>
          <Link href={legalHref("/contacto", from)}>Contacto</Link>
          <a
