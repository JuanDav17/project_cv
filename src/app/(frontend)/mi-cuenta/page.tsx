      ...
      <DashboardSidebar
        ...
        footer={
          <div className="fp-stack-md">
            <Link className="fp-sidebar__link fp-label-md" href="/ayuda?from=/mi-cuenta">
            ...
            <div className="fp-settings-top-row">
              ...
              <article className="fp-card fp-card--panel fp-stack-lg fp-settings-interests">
                <div className="fp-settings-interests__header">
                  ...
                  <Link href="/editar_areas" className="fp-button fp-button--ghost">
                ...
                {interests.length === 0 ? (
                  <div className="fp-settings-interests__empty">
                    ...
                    <Link href="/editar_areas" className="fp-button fp-button--soft">
